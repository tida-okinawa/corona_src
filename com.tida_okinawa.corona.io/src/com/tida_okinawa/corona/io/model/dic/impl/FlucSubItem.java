/**
 * @version $Id: FlucSubItem.java 1839 2014-04-16 02:33:51Z yukihiro-kinjyo $
 * 
 * 2011/09/27 10:31:32
 ...
 * @author shingo-takahashi
 */
public class FlucSubItem extends DependSub {
    /**
     * @param id
     * @param term
     *            従属語
     ...
     *            自身が属している代表語アイテム
     */
    public FlucSubItem(int id, ITerm term, IDepend parent) {
