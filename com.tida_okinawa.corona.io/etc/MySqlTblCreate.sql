...
DROP INDEX DIC_ID ON DIC_COMMON;
DROP INDEX ITEM_ID ON DIC_FLUC;
DROP INDEX DIC_ID ON DIC_FLUC;
DROP INDEX DIC_ID ON DIC_LABEL;
DROP INDEX DIC_ID ON DIC_PATTERN;
DROP INDEX ITEM_ID ON DIC_SYNONYM;
DROP INDEX DIC_ID ON DIC_SYNONYM;
DROP INDEX CATEGORY_ID ON DIC_TABLE;
DROP INDEX TBL_ID ON FIELDS;
DROP INDEX ITEM_ID ON FLUC_TBL;
DROP INDEX DIC_ID ON FLUC_TBL;
DROP INDEX CHILD_ID ON LABEL_TREE;
DROP INDEX PRODUCT_ID ON REL_CLM_PRODUCT;
DROP INDEX PRJ_ID ON REL_CLM_PRODUCT;
DROP INDEX ITEM_ID ON REL_COMMON_LABEL;
DROP INDEX LABEL_ID ON REL_COMMON_LABEL;
DROP INDEX DIC_ID ON REL_COMMON_LABEL;
DROP INDEX FLUC_ID ON REL_FLUC;
DROP INDEX TBL_ID ON REL_PRJ_CLM;
DROP INDEX DIC_ID ON REL_PRJ_DIC;
DROP INDEX DIC_ID ON REL_PRODUCT_DIC;
DROP INDEX SYNONYM_ID ON REL_SYNONYM;
DROP INDEX ITEM_ID ON SYNONYM_TBL;
DROP INDEX DIC_ID ON SYNONYM_TBL;
