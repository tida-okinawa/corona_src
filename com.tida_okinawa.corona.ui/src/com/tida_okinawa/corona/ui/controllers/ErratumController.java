...
import com.tida_okinawa.corona.ui.data.ErratumCheckRecord;
import com.tida_okinawa.corona.ui.data.ErratumCorrectionRecord;
import com.tida_okinawa.corona.ui.wizards.ErratumManualDialog;
...
public class ErratumController implements IRunnableWithProgress {
     ...
     *            処理結果を受け取るリスナー
     */
    public ErratumController(Shell shell, IClaimData claimData, List<IFieldHeader> fields, IListener<ErratumCorrectionRecord> listener) {
        this.shell = shell;
    ...
    class Controller extends AsyncController<ErratumCheckRecord, ErratumCorrectionRecord> {
        ...
        Controller(final int claimId, final int fieldId) {
