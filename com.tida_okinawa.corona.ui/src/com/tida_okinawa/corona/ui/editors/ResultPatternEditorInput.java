/**
 * @version $Id: ResultPatternEditorInput.java 1839 2014-04-16 02:33:51Z yukihiro-kinjyo $
 *
 * 2011/09/02 21:49:11
 * @author imai
 *
...
public class ResultPatternEditorInput implements IEditorInput, IResultPatternEditorInput {
    final String name;
     ...
     *            構文解析結果中間データ
     */
    public ResultPatternEditorInput(String name, final IClaimWorkPattern claimWorkPattern) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ResultPatternEditorInput)) {
            return false;
        }
